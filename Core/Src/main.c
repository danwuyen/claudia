...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, WTF_IS_THIS__Pin|TRIG_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : WTF_IS_THIS__Pin TRIG_Pin */
  GPIO_InitStruct.Pin = WTF_IS_THIS__Pin|TRIG_Pin;
